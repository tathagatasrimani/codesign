...
#ifdef  CCS_DESIGN_FUNC_MatMult_run
#define ccs_intercept_run_10 \
  run(ac_channel<PackedInt2D<16UL, 5UL, 5UL > > &a_chan,ac_channel<PackedInt2D<16UL, 5UL, 5UL > > &b_chan,ac_channel<PackedInt2D<16UL, 5UL, 5UL > > &c_chan);\
  void ccs_real_run
#else
#define ccs_intercept_run_10 run
#endif //CCS_DESIGN_FUNC_MatMult_run
...
// MatMult 5 MODULE
#define ccs_intercept_MatMult_5 MatMult
