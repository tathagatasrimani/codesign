ifeq "$(CXX_HOME)" ""
CXX_HOME                                              := /nfs/cad/mentor/2019.11/Catapult_Synthesis_10.4b-841621/Mgc_home
export CXX_HOME
endif
ifeq "$(CXX_TYPE)" ""
CXX_TYPE                                              := gcc
...
OSCI_SYSTEMC_INCLUDE                                  := /nfs/cad/mentor/2019.11/Catapult_Synthesis_10.4b-841621/Mgc_home/shared/include
export OSCI_SYSTEMC_INCLUDE
endif
ifeq "$(OSCI_SYSTEMC_LIB)" ""
OSCI_SYSTEMC_LIB                                      := /nfs/cad/mentor/2019.11/Catapult_Synthesis_10.4b-841621/Mgc_home/shared/lib/$(CXX_OS)/$(CXX_TYPE)
