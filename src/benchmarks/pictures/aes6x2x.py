...
"]
	107 [label="for i in range(6):
"]
	108 [label="loop().pattern_seek()
aes = AES(1212304810341341)
aes.encrypt(1212304810341341)
"]
	"108_calls" [label="Call.pattern_seek
AES
aes.encrypt" shape=box]
	108 -> "108_calls" [label=calls style=dashed]
	108 -> 107 [label=""]
	107 -> 108 [label="range(6)"]
	109 [label="for i in range(6):
"]
	110 [label="loop().pattern_seek()
aes = AES(1212304810341341)
aes.encrypt(1212304810341341)
"]
	"110_calls" [label="Call.pattern_seek
AES
aes.encrypt" shape=box]
	110 -> "110_calls" [label=calls style=dashed]
	110 -> 109 [label=""]
	109 -> 110 [label="range(6)"]
	111 [label="end = time.time()
"]
	"111_calls" [label="time.time" shape=box]
