...
//  Generated date: Tue Mar  4 15:09:15 2025
// ----------------------------------------------------------------------

// 
// ------------------------------------------------------------------
//  Design Unit:    MatMult_ccs_sample_mem_ccs_ram_sync_1R1W_wport_3_16_14_10000_10000_16_5_gen
// ------------------------------------------------------------------


module MatMult_ccs_sample_mem_ccs_ram_sync_1R1W_wport_3_16_14_10000_10000_16_5_gen
    (
...
// ------------------------------------------------------------------
//  Design Unit:    MatMult_ccs_sample_mem_ccs_ram_sync_1R1W_rport_2_16_14_10000_10000_16_5_gen
// ------------------------------------------------------------------


module MatMult_ccs_sample_mem_ccs_ram_sync_1R1W_rport_2_16_14_10000_10000_16_5_gen
    (
...
// ------------------------------------------------------------------
//  Design Unit:    MatMult_ccs_sample_mem_ccs_ram_sync_1R1W_rport_1_16_14_10000_10000_16_5_gen
// ------------------------------------------------------------------


module MatMult_ccs_sample_mem_ccs_ram_sync_1R1W_rport_1_16_14_10000_10000_16_5_gen
    (
  q, re, radr, radr_d, re_d, q_d, port_0_r_ram_ir_internal_RMASK_B_d
);
  input [15:0] q;
...
module MatMult_run (
  ...
  wire [15:0] for_1_for_tmp_sva_2;
  wire [16:0] nl_for_1_for_tmp_sva_2;
  ...
  wire and_67_nl;
  wire[15:0] multiplier_mul_nl;
  wire[31:0] nl_multiplier_mul_nl;
  ...
  assign nl_multiplier_mul_nl = a_chan_rsci_q_d_mxwt * b_chan_rsci_q_d_mxwt;
  assign multiplier_mul_nl = nl_multiplier_mul_nl[15:0];
  assign nl_for_1_for_tmp_sva_2 = for_1_for_for_1_for_and_itm_1 + multiplier_mul_nl;
  assign for_1_for_tmp_sva_2 = nl_for_1_for_tmp_sva_2[15:0];
  ...
  assign c_chan_rsci_d_d = MUX_v_16_2_2(16'b0000000000000000, for_1_for_tmp_sva_2,
      (fsm_output[3]));
  ...
  always @(posedge clk or negedge arst_n) begin
    if ( ~ arst_n ) begin
      ...
      for_1_for_for_1_for_and_itm_1 <= MUX_v_16_2_2(16'b0000000000000000, for_1_for_tmp_sva_2,
          and_67_nl);
    end
  end
  always @(posedge clk or negedge arst_n) begin
...
module MatMult_struct (
  ...
  // Interconnect Declarations for Component Instantiations 
  MatMult_ccs_sample_mem_ccs_ram_sync_1R1W_rport_1_16_14_10000_10000_16_5_gen a_chan_rsci
      (
      .q(a_chan_rsc_q),
      .re(a_chan_rsc_re),
  ...
  MatMult_ccs_sample_mem_ccs_ram_sync_1R1W_rport_2_16_14_10000_10000_16_5_gen b_chan_rsci
      (
      .q(b_chan_rsc_q),
      .re(b_chan_rsc_re),
  ...
  MatMult_ccs_sample_mem_ccs_ram_sync_1R1W_wport_3_16_14_10000_10000_16_5_gen c_chan_rsci
      (
      .we(c_chan_rsc_we),
      .d(c_chan_rsc_d),
