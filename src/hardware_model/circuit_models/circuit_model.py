...
class CircuitModel:
    def __init__(self, tech_model):
        ...
        self.symbolic_latency_wc = {
            "And": lambda: self.make_sym_lat_wc(self.gamma["And16"]),
            "Or": lambda: self.make_sym_lat_wc(self.gamma["Or16"]),
            "Add": lambda: self.make_sym_lat_wc(self.gamma["Add16"]),
            "Sub": lambda: self.make_sym_lat_wc(self.gamma["Sub16"]),
            "Mult": lambda: self.make_sym_lat_wc(self.gamma["Mult16"]),
            "FloorDiv": lambda: self.make_sym_lat_wc(self.gamma["FloorDiv16"]),
            "Mod": lambda: self.make_sym_lat_wc(self.gamma["Modulus16"]),
            "LShift": lambda: self.make_sym_lat_wc(self.gamma["LShift16"]),
            "RShift": lambda: self.make_sym_lat_wc(self.gamma["RShift16"]),
            "BitOr": lambda: self.make_sym_lat_wc(self.gamma["BitOr16"]),
            "BitXor": lambda: self.make_sym_lat_wc(self.gamma["BitXor16"]),
            "BitAnd": lambda: self.make_sym_lat_wc(self.gamma["BitAnd16"]),
            "Eq": lambda: self.make_sym_lat_wc(self.gamma["Eq16"]),
            "NotEq": lambda: self.make_sym_lat_wc(self.gamma["NotEq16"]),
            "Lt": lambda: self.make_sym_lat_wc(self.gamma["Lt16"]),
            "LtE": lambda: self.make_sym_lat_wc(self.gamma["LtE16"]),
            "Gt": lambda: self.make_sym_lat_wc(self.gamma["Gt16"]),
            "GtE": lambda: self.make_sym_lat_wc(self.gamma["GtE16"]),
            "Not": lambda: self.make_sym_lat_wc(self.gamma["Not16"]),
            "Regs": lambda: self.make_sym_lat_wc(self.gamma["Register16"]),   
        ...
        self.symbolic_energy_active = {
            "And": lambda: self.make_sym_energy_act(self.alpha["And16"]),
            "Or": lambda: self.make_sym_energy_act(self.alpha["Or16"]),
            "Add": lambda: self.make_sym_energy_act(self.alpha["Add16"]),
            "Sub": lambda: self.make_sym_energy_act(self.alpha["Sub16"]),
            "Mult": lambda: self.make_sym_energy_act(self.alpha["Mult16"]),
            "FloorDiv": lambda: self.make_sym_energy_act(self.alpha["FloorDiv16"]),
            "Mod": lambda: self.make_sym_energy_act(self.alpha["Modulus16"]),
            "LShift": lambda: self.make_sym_energy_act(self.alpha["LShift16"]),
            "RShift": lambda: self.make_sym_energy_act(self.alpha["RShift16"]),
            "BitOr": lambda: self.make_sym_energy_act(self.alpha["BitOr16"]),
            "BitXor": lambda: self.make_sym_energy_act(self.alpha["BitXor16"]),
            "BitAnd": lambda: self.make_sym_energy_act(self.alpha["BitAnd16"]),
            "Eq": lambda: self.make_sym_energy_act(self.alpha["Eq16"]),
            "NotEq": lambda: self.make_sym_energy_act(self.alpha["NotEq16"]),
            "Lt": lambda: self.make_sym_energy_act(self.alpha["Lt16"]),
            "LtE": lambda: self.make_sym_energy_act(self.alpha["LtE16"]),
            "Gt": lambda: self.make_sym_energy_act(self.alpha["Gt16"]),
            "GtE": lambda: self.make_sym_energy_act(self.alpha["GtE16"]),
            "Not": lambda: self.make_sym_energy_act(self.alpha["Not16"]),
            "Regs": lambda: self.make_sym_energy_act(self.alpha["Register16"]),
        ...
        self.symbolic_power_passive = {
            "And": lambda: self.make_sym_power_pass(self.beta["And16"]),
            "Or": lambda: self.make_sym_power_pass(self.beta["Or16"]),
            "Add": lambda: self.make_sym_power_pass(self.beta["Add16"]),
            "Sub": lambda: self.make_sym_power_pass(self.beta["Sub16"]),
            "Mult": lambda: self.make_sym_power_pass(self.beta["Mult16"]),
            "FloorDiv": lambda: self.make_sym_power_pass(self.beta["FloorDiv16"]),
            "Mod": lambda: self.make_sym_power_pass(self.beta["Modulus16"]),
            "LShift": lambda: self.make_sym_power_pass(self.beta["LShift16"]),
            "RShift": lambda: self.make_sym_power_pass(self.beta["RShift16"]),
            "BitOr": lambda: self.make_sym_power_pass(self.beta["BitOr16"]),
            "BitXor": lambda: self.make_sym_power_pass(self.beta["BitXor16"]),
            "BitAnd": lambda: self.make_sym_power_pass(self.beta["BitAnd16"]),
            "Eq": lambda: self.make_sym_power_pass(self.beta["Eq16"]),
            "NotEq": lambda: self.make_sym_power_pass(self.beta["NotEq16"]),
            "Lt": lambda: self.make_sym_power_pass(self.beta["Lt16"]),
            "LtE": lambda: self.make_sym_power_pass(self.beta["LtE16"]),
            "Gt": lambda: self.make_sym_power_pass(self.beta["Gt16"]),
            "GtE": lambda: self.make_sym_power_pass(self.beta["GtE16"]),
            "Not": lambda: self.make_sym_power_pass(self.beta["Not16"]),
            "Regs": lambda: self.make_sym_power_pass(self.beta["Register16"]),
        ...
        # UNITS: um^2
        self.symbolic_area = {
            "And": lambda: self.make_sym_area(self.area_coeffs["And16"]),
            "Or": lambda: self.make_sym_area(self.area_coeffs["Or16"]),
            "Add": lambda: self.make_sym_area(self.area_coeffs["Add16"]),
            "Sub": lambda: self.make_sym_area(self.area_coeffs["Sub16"]),
            "Mult": lambda: self.make_sym_area(self.area_coeffs["Mult16"]),
            "FloorDiv": lambda: self.make_sym_area(self.area_coeffs["FloorDiv16"]),
            "Mod": lambda: self.make_sym_area(self.area_coeffs["Modulus16"]),
            "LShift": lambda: self.make_sym_area(self.area_coeffs["LShift16"]),
            "RShift": lambda: self.make_sym_area(self.area_coeffs["RShift16"]),
            "BitOr": lambda: self.make_sym_area(self.area_coeffs["BitOr16"]),
            "BitXor": lambda: self.make_sym_area(self.area_coeffs["BitXor16"]),
            "BitAnd": lambda: self.make_sym_area(self.area_coeffs["BitAnd16"]),
            "Eq": lambda: self.make_sym_area(self.area_coeffs["Eq16"]),
            "NotEq": lambda: self.make_sym_area(self.area_coeffs["NotEq16"]),
            "Lt": lambda: self.make_sym_area(self.area_coeffs["Lt16"]),
            "LtE": lambda: self.make_sym_area(self.area_coeffs["LtE16"]),
            "Gt": lambda: self.make_sym_area(self.area_coeffs["Gt16"]),
            "GtE": lambda: self.make_sym_area(self.area_coeffs["GtE16"]),
            "Not": lambda: self.make_sym_area(self.area_coeffs["Not16"]),
            "Regs": lambda: self.make_sym_area(self.area_coeffs["Register16"]),
            "N/A": lambda: 0,
            "Call": lambda: 0,
        }
