...
FILES {
  { FILENAME /cad/mentor/2024.2/Mgc_home/pkgs/siflibs/ccs_ram_sync_dualport.v FILETYPE Verilog MODELTYPE generic PARSE 1 PATHTYPE copy STATICFILE 1 VHDL_LIB_MAPS work }
}
VHDLARRAYPATH    {}
WRITEDELAY       2.5
INITDELAY        1
