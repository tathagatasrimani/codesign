...
test" shape=box]
	...
	subgraph clustertext2matrix {
		...
		3 [label="matrix = []
"]
		4 [label="for i in range(16):
"]
		5 [label="byte = int(text) >> 8 * (15 - i) & 255
if i % 4 == 0:
"]
		"5_calls" [label=int shape=box]
		5 -> "5_calls" [label=calls style=dashed]
		7 [label="matrix.append([byte])
"]
		"7_calls" [label="matrix.append" shape=box]
		7 -> "7_calls" [label=calls style=dashed]
		7 -> 4 [label=""]
		5 -> 7 [label="i % 4 == 0"]
		9 [label="matrix[int(i / 4)].append(byte)
"]
		"9_calls" [label="matrix.append" shape=box]
		9 -> "9_calls" [label=calls style=dashed]
		9 -> 4 [label=""]
		5 -> 9 [label="(i % 4 != 0)"]
		4 -> 5 [label="range(16)"]
		6 [label="return matrix
"]
		4 -> 6 [label=""]
		3 -> 4 [label=""]
	}
	subgraph clustermatrix2text {
		...
		13 [label="text = 0
"]
		14 [label="for i in range(4):
"]
		15 [label="for j in range(4):
"]
		17 [label="text |= matrix[i][j] << 120 - 8 * (4 * i + j)
"]
		17 -> 15 [label=""]
		15 -> 17 [label="range(4)"]
		15 -> 14 [label=""]
		14 -> 15 [label="range(4)"]
		16 [label="return text
"]
		14 -> 16 [label=""]
		13 -> 14 [label=""]
	}
	subgraph clusterxtime {
		graph [label=xtime]
		22 [label="return (a << 1 ^ 27) & 255 if a & 128 else a << 1
"]
	}
...
"]
	...
	subgraph clustertest {
		graph [label=test]
		103 [label="aes.in_1.wr('1212304810341341')
aes.encrypt('adflkadhlkfd')
"]
		"103_calls" [label="aes.in_1.wr
