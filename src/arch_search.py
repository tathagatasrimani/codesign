...
def generate_new_arch_aladdin(cfg: CFG, hw: HardwareModel, node_operation_map, data_path, id_to_node):
    """
    ...
    """
    i, pattern_seek, max_iters = sim_util.find_next_data_path_index(data_path, i, mallocs, frees)
    ...
    while i < len(data_path):
        (
            ...
            pattern_seek_next,
            max_iters_next,
        ) = sim_util.find_next_data_path_index(data_path, i + 1, mallocs, frees)
