...
def forward(self, primals_1, primals_2, primals_3, primals_4, primals_5, primals_6, primals_7):
    ...
    broadcast_in_dim = torch.ops.prims.broadcast_in_dim.default(mul_1, [1, 512], [1]);  mul_1 = None
    ...
    broadcast_in_dim_1 = torch.ops.prims.broadcast_in_dim.default(mul_3, [1, 512], [1]);  mul_3 = None
    ...
    broadcast_in_dim_2 = torch.ops.prims.broadcast_in_dim.default(mul_5, [1, 10], [1]);  mul_5 = None
