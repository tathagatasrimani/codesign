    ...
    def Initialize(self, _numAddressBit, _capLoad, _resLoad):
        ...
        if self.numAddressBit > 27:
            ...
            if numBasicDecoder <= 1:
                ...
                self.rowDecoderStage1A.Initialize(
                    self.numOutputAddressBit, self.capLoad, self.resLoad,
                    self.numNandInputStage1A == 3, BufferDesignTarget.latency_first, 0
                )
                ...
                if numBasicDecoder <= 6:
                    ...
                    self.rowDecoderStage2.Initialize(
                        self.numOutputAddressBit, self.capLoad, self.resLoad,
                        False, BufferDesignTarget.latency_first, 0
                    )
                    ...
                    self.rowDecoderStage1A = RowDecoder()
                    self.rowDecoderStage1A.Initialize(
                        self.numAddressBitStage1A, capLoadStage1A, 0,
                        self.numNandInputStage1A == 3, BufferDesignTarget.latency_first, 0
                    )
                    self.rowDecoderStage1A.CalculateRC()

                    self.rowDecoderStage1B = RowDecoder()
                    self.rowDecoderStage1B.Initialize(
                        self.numAddressBitStage1B, capLoadStage1B, 0,
                        self.numNandInputStage1B == 3, BufferDesignTarget.latency_first, 0
                    )
                    ...
                    self.rowDecoderStage1C.Initialize(
                        self.numAddressBitStage1C, capLoadStage1C, 0,
                        self.numNandInputStage1C == 3, BufferDesignTarget.latency_first, 0
                    )
